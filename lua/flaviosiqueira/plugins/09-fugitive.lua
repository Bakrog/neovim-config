...
return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "<leader>gb", function() branch_picker(require("telescope.themes").get_dropdown({})) end,
            { desc = "Git Branches (Pick)" }) -- Use the picker
        vim.keymap.set("n", "<leader>ga", function() vim.cmd.Git("add " .. vim.fn.expand("%")) end,
        ...
        vim.keymap.set("n", "<leader>gl", function() vim.cmd.Git("pull --rebase --autostash") end,
            { desc = "Git Pull Rebase" })
        vim.keymap.set("n", "<leader>gr",
            function() vim.cmd.Git("rebase -i " .. vim.fn.input("Rebase from: ", "main")) end,
            { desc = "Git Rebase Interactive" })
        vim.keymap.set("n", "<leader>gco", function() vim.cmd.Git("checkout " .. vim.fn.input("Checkout: ")) end,
            { desc = "Git Checkout" })
